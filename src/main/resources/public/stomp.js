...
(function() {
    ...
    Frame = (function() {
        ...
        Frame._unmarshallSingle = function(data) {
            ...
            while(body.length > 0 && body.charCodeAt(0) <= 10)
                body = body.substring(1);
            while(body.length > 0 && body.charCodeAt(body.length-1) <= 10)
                body = body.substring(0, body.length-1);
            return new Frame(command, headers, body.trim());
        };

        Frame.unmarshall = function(datas) {
            var startIdx = datas.indexOf("" + Byte.LF  + Byte.LF + Byte.NULL);
            if(startIdx > 0) {
                //var endIdx = startIdx;
                // while(true) {
                //     var nextIdx = -1;
                    // for(var loopA=endIdx+3; loopA<datas.length; loopA++){
                    //     var c1 = datas.charCodeAt(loopA);
                    //     if(c1 !== 65533)
                    //         continue;
                    //     if((loopA + 3) >= datas.length)
                    //         break;
                    //     var c2 = datas.charCodeAt(loopA+1);
                    //     if(c2 !== 0)
                    //         continue;
                    //     var c3 = datas.charCodeAt(loopA+2);
                    //     if(c3 !== 3)
                    //         continue;
                    //
                    //     var bodyIdx = datas.indexOf("" + Byte.LF + Byte.LF, loopA+3);
                    //     if(bodyIdx < 0 || bodyIdx > (loopA + 20))
                    //         continue;
                    //
                    //     nextIdx = bodyIdx+2;
                    //     break;
                ...
                //     endIdx = nextIdx;
                // }
                var endIdx = datas.indexOf("" + '\x02'+ '\x02'+ '\x02');
                if(endIdx > 0 && startIdx !== endIdx) {
                    datas = datas.substring(0, startIdx+3) + datas.substring(endIdx+3);
                }
            }
            var data;
            return (function() {
